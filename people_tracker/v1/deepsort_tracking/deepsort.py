from deepsort_tracking.deep_sort.deep_sort import nn_matching
from deepsort_tracking.deep_sort.deep_sort.tracker import Tracker 
from deepsort_tracking.deep_sort.application_util import preprocessing as prep
from deepsort_tracking.deep_sort.application_util import visualization
from deepsort_tracking.deep_sort.deep_sort.detection import Detection
...
class deepsort_rbc():
	def __init__(self,wt_path=None):
		...
		if wt_path is not None:
			...
			self.encoder = torch.load('./deepsort_tracking/ckpts/model640.pt')
